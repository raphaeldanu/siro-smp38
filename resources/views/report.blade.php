      ...
      <div class="card-body px-0 pt-0">
        ...
        <p class="card-text">
          ...
          <div class="row">
            ...
            <div class="col-8">: {{ $student->nis }}</div>
          </div>
          <div class="row">
            <div class="col-4">Tahun Pelajaran</div>
            <div class="col-8">: {{ $report->tahun_pelajaran }}</div>
          </div>
          <div class="row">
            <div class="col-4">Kelas</div>
            <div class="col-8">: {{ $report->kelas . $report->rombel }}</div>
          </div>
          <div class="row">
            <div class="col-4">Semester</div>
            <div class="col-8">: {{ $report->semester }}</div>
          </div>  
        </p>
      </div> 
    </div>
