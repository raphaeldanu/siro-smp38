  ...
  <div class="px-0 col-lg-8">
    ...
    <form action="/dashboard/reports/{{ $report->id }}" method="POST">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_agama_p') is-invalid @enderror" id="n_agama_p" name="n_agama_p" value="{{ $report->n_agama_p }}">
          @error('n_agama_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_agama_k') is-invalid @enderror" id="n_agama_k" name="n_agama_k" value="{{ $report->n_agama_k }}">
          @error('n_agama_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_ppkn_p') is-invalid @enderror" id="n_ppkn_p" name="n_ppkn_p" value="{{ $report->n_ppkn_p }}">
          @error('n_ppkn_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_ppkn_k') is-invalid @enderror" id="n_ppkn_k" name="n_ppkn_k" value="{{ $report->n_ppkn_k }}">
          @error('n_ppkn_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_bindo_p') is-invalid @enderror" id="n_bindo_p" name="n_bindo_p" value="{{ $report->n_bindo_p }}">
          @error('n_bindo_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_bindo_k') is-invalid @enderror" id="n_bindo_k" name="n_bindo_k" value="{{ $report->n_bindo_k }}">
          @error('n_bindo_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_mat_p') is-invalid @enderror" id="n_mat_p" name="n_mat_p" value="{{ $report->n_mat_p }}">
          @error('n_mat_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_mat_k') is-invalid @enderror" id="n_mat_k" name="n_mat_k" value="{{ $report->n_mat_k }}">
          @error('n_mat_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_ipa_p') is-invalid @enderror" id="n_ipa_p" name="n_ipa_p" value="{{ $report->n_ipa_p }}">
          @error('n_ipa_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_ipa_k') is-invalid @enderror" id="n_ipa_k" name="n_ipa_k" value="{{ $report->n_ipa_k }}">
          @error('n_ipa_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_ips_p') is-invalid @enderror" id="n_ips_p" name="n_ips_p" value="{{ $report->n_ips_p }}">
          @error('n_ips_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_ips_k') is-invalid @enderror" id="n_ips_k" name="n_ips_k" value="{{ $report->n_ips_k }}">
          @error('n_ips_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_bing_p') is-invalid @enderror" id="n_bing_p" name="n_bing_p" value="{{ $report->n_bing_p }}">
          @error('n_bing_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_bing_k') is-invalid @enderror" id="n_bing_k" name="n_bing_k" value="{{ $report->n_bing_k }}">
          @error('n_bing_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_seni_p') is-invalid @enderror" id="n_seni_p" name="n_seni_p" value="{{ $report->n_seni_p }}">
          @error('n_seni_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_seni_k') is-invalid @enderror" id="n_seni_k" name="n_seni_k" value="{{ $report->n_seni_k }}">
          @error('n_seni_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_penjas_p') is-invalid @enderror" id="n_penjas_p" name="n_penjas_p" value="{{ $report->n_penjas_p }}">
          @error('n_penjas_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_penjas_k') is-invalid @enderror" id="n_penjas_k" name="n_penjas_k" value="{{ $report->n_penjas_k }}">
          @error('n_penjas_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_prakarya_p') is-invalid @enderror" id="n_prakarya_p" name="n_prakarya_p" value="{{ $report->n_prakarya_p }}">
          @error('n_prakarya_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_prakarya_k') is-invalid @enderror" id="n_prakarya_k" name="n_prakarya_k" value="{{ $report->n_prakarya_k }}">
          @error('n_prakarya_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_bjawa_p') is-invalid @enderror" id="n_bjawa_p" name="n_bjawa_p" value="{{ $report->n_bjawa_p }}">
          @error('n_bjawa_p')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="col-sm-4">
          <input type="number" class="form-control @error('n_bjawa_k') is-invalid @enderror" id="n_bjawa_k" name="n_bjawa_k" value="{{ $report->n_bjawa_k }}">
          @error('n_bjawa_k')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
